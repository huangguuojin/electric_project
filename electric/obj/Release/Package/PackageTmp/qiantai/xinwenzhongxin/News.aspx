<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="News.aspx.cs" Inherits="electric.News" %>
                    ...
                    <div class="col-md-9">
                           <div class="media">
                               ...
                               <div class="media-body">
                                    <h4 class="media-heading"><a href="#">汽车电子产品呼唤创新 </a></h4>
                                     <div >
                                         <p>谈到制造，谈到科技，谈到企业发展，我们就不能不提到一个词“创新”。创新是一个民族进步的灵魂，是国家兴旺发达的不竭动力。此次十八届三中全会就在公报里11次提到创新。然而，在人人倡导创新，社会鼓励创新的同时，企业是否真的做好了创新却是一个令人质疑的问题。先不说别的行业，就只看汽车电子...
</p>
                                     </div>
                                    </div>
                           </div>
                        ...
                        <div class="media">
                         ...
                         <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading"><a href="NewDetails.aspx">高清需求在即 监视器步入发展快车道</a></h4>
                                <div >
                                 <p class=" articleText">近日，xx电子系统有限公司与xx市xx县交通运输局展开合作，由xx提供的3×7超窄边液晶拼接系统成功进驻该局监控指挥中心，作为监控显示终端将24小时全天候监控道路运输，保障犍为公路运输的安全稳定运行。为保障全县道路运输安全，开创道路运输行业高科技管理新局面，xx县交通管理局积极筹...
</p>
                                </div>
                            </div>
                        </div>
                         <div class="media">
                             <a class="pull-left" href="NewDetails.aspx">
                                  <img src="http://file.tuweia.cn/M00/01/7D/CoPea1Qf3_OAD8UKAADqo8rAkQU231_center_320_320.jpg">
                             </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="NewDetails.aspx">液晶拼接保卫吉林延边林业安全</a></h4>
                                <div >
                                 <p class=" articleText">近日，xx电子系统有限公司与xx市xx县交通运输局展开合作，由xx提供的3×7超窄边液晶拼接系统成功进驻该局监控指挥中心，作为监控显示终端将24小时全天候监控道路运输，保障犍为公路运输的安全稳定运行。为保障全县道路运输安全，开创道路运输行业高科技管理新局面，xx县交通管理局积极筹...
</p>
                                </div>
