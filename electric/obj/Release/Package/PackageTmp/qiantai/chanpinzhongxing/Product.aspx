<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="electric.Product" %>
                       ...
                       <div>
                           <table class="table-responsive tab">
                               <tr>
                                   <td>
                                       <div>
                                       <a href="ProductDetail.aspx"> <img src="http://file.tuweia.cn/M00/25/6A/CoPea1TwD92AQ75kAAAcg7skM3Q042.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">供应CARTER触摸显示器,液晶触摸屏</a></p>
                                       </div>
                                   </td>
                                   <td>
                                       <div>
                                        <a href="ProductDetail.aspx"> <img src="http://file.tuweia.cn/M00/25/6A/CoPea1TwD92ABrHXAAAY4WKN9kQ969.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">供应CARTER触摸显示器,液晶触摸屏.</a></p>
                                       </div>
                                   </td>
                                    <td>
                                        <div>
                                        <a href="ProductDetail.aspx"> <img src="http://file.tuweia.cn/M00/25/6B/CoPea1TwD92AWYuYAAAbmRJ5-xo750.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">供应CARTER触摸显示器,液晶触摸屏</a></p>
                                         </div>
                                   </td>
                               </tr>
                                   ...
                                   <td>
                                       <div>
                                       <a href="ProductDetail.aspx"> <img src="http://file.tuweia.cn/M00/25/6A/CoPea1TwD92AZFZHAAAfCk47HnY613.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90"  class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">供应CARTER触摸显示器,液晶触摸屏</a></p>
                                       </div>
                                   </td>
                                   <td>
