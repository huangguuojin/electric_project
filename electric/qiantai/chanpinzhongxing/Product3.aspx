<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Product3.aspx.cs" Inherits="electric.Product3" %>
                       ...
                       <div>
                           <table class="table-responsive tab">
                               <tr>
                                   <td>
                                       <div>
                                       <a href="#"> <img src="http://file.tuweia.cn/M00/25/B2/CoPea1Txdf6AK-lCAABPgtdVTEc840.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">常用的家用血压仪</a></p>
                                       </div>
                                   </td>
                                   <td>
                                       <div>
                                        <a href="#"> <img src="http://file.tuweia.cn/M00/25/B2/CoPea1Txdf-AKTJrAABigOkmT0M040.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">常用的家用血压仪</a></p>
                                       </div>
                                   </td>
                                    <td>
                                        <div>
                                        <a href="#"> <img src="http://file.tuweia.cn/M00/25/B2/CoPea1Txdf-AEfZVAAKNkX6KHJo197.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">常用的家用血压仪</a></p>
                                         </div>
                                   </td>
                               </tr>
                                   ...
                                   <td>
                                       <div>
                                       <a href="#"> <img src="http://file.tuweia.cn/M00/25/B2/CoPea1Txdf-ARcMdAAF0ELCp7cE104.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">常用的家用血压仪</a></p>
                                       </div>
                                   </td>
                                   <td>
                                       <div>
                                        <a href="#"> <img src="http://file.tuweia.cn/M00/25/B2/CoPea1Txdf6AHyy0AACosxOtlgQ845.jpg?imageMogr2/thumbnail/!235x235r/crop/235x235/quality/90" class="responsiveImage articlePic" /></a>
                                       <p style="text-align:center;"><a href="#">常用的家用血压仪</a></p>
                                       </div>
                                   </td>
                                    <td>
